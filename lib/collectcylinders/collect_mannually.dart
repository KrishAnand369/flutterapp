...
class CollectMannually extends StatefulWidget {
  String accessToken;

  CollectMannually({super.key, Key? mykey, required this.accessToken});

  @override
  State<CollectMannually> createState() => _CollectMannuallyState();
}

class _CollectMannuallyState extends State<CollectMannually> {
