...
import 'package:oru_app/collectcylinders/collect_mannually.dart';
import 'package:oru_app/functions.dart';
import 'package:oru_app/reusables.dart';
import 'package:oru_app/collectcylinders/collect_scanner.dart';
import 'package:http/http.dart' as http;

class CollectCylinders extends StatefulWidget {
  List qrList;
  ...
  @override
  State<CollectCylinders> createState() => _CollectCylindersState();
}

class _CollectCylindersState extends State<CollectCylinders> {
  List cylinderId = [];
  bool flag = false;
  bool cancel = false;
  List customerID = [];
          ...
          IconButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Collect_Scanner(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => CollectMannually(
                            accessToken: widget.accessToken,
                          )),
                );
              },
